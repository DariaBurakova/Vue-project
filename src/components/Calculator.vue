<template>
  <div>
    ...
    <div>
      <button v-for="item in operands" :key="item" :value="item" @click="calcul(item)">{{item}}</button>
    </div>
    ...
    <div class="keyboard" v-show="checked!=false">
      <button v-for="item in collection" :key="item" :value="item" @click="keyboard(item)">{{item}}</button>
